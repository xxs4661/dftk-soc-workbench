...
| Phase 7G public cross-environment replay | [Prepared independent readers/math, fixed Linux workflow and blocked push](../results/mg-soc-public-replay/README.md). 47 Mac synthetic tests PASS; 59 public file bytes match the accepted base. | **BLOCKED** by existing credential missing workflow scope. Linux/R/I **NOT_RUN**, numerical and WFC/member gates NOT_RUN; A/B intended scope SCALAR_AND_PROJECTED_ONLY. No new cross-platform conclusion. |
