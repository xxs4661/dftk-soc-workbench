...
| Si finite SOC sensitivity | [E40/T05/K4 preparation](../results/si-soc-sensitivity/README.md), at most12 new slots; B0 HISTORICAL_REUSED. | PREPARED_NOT_EXECUTED; code agreement and finite-step stability are separate. Physical convergence NOT_ESTABLISHED. |
