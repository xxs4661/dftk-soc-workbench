...
Original preparation inputs are frozen. [Historical results](../../results/si-soc-splitting/README.md)
and the [current status correction](../../results/si-soc-splitting/status-correction/README.md)
are separate from this original plan. Two-atom diamond Si uses one byte-bound
